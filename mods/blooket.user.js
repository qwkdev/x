...
retry(500, () => {
    (() => {
        ...
        l.appendChild(i), i.style.background = "transparent", i.style.color = "red", i.style.height = "45px", i.style.width = "45px", i.style.border = "none", i.style.cursor = "pointer", i.style.position = "absolute", i.style.top = "-8px", i.style.right = "-10px", i.style.fontSize = "24px", i.style.borderRadius = "10px", i.style.fontFamily = "Nunito", i.style.fontWeight = "bolder", i.style.paddingTop = "10px", i.style.paddingRight = "15px", i.innerText = "X", i.onclick = () => {
            t.remove(), clearInterval(s), removeEventListener("keypress", M)
        };
        let d = document.createElement("button");
        l.appendChild(d), d.style.background = "transparent", d.style.color = "white", d.style.height = "45px", d.style.width = "45px", d.style.border = "none", d.style.cursor = "pointer", d.style.position = "absolute", d.style.top = "-14px", d.style.left = "-8px", d.style.fontSize = "32px", d.style.borderRadius = "10px", d.style.fontFamily = "Nunito", d.style.fontWeight = "bolder", d.style.paddingTop = "10px", d.style.paddingLeft = "15px", d.innerText = "-", d.onclick = () => {
            c.hidden = !c.hidden
        };
