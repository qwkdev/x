// ==UserScript==
// @name        Krunker Hack Menu
// @namespace   krunker-xmods
// @match       *://krunker.io/*
// @grant       none
// @version     6.9
// @author      XMODS
// @description Full krunker hack menu, with best rage config pre-loaded
...
function cheat() {
  ...
  class _0x1a8eea {
    ...
    getGuiHtml() {
      ...
      let _0x2a4cd2 = "<div id=\"settHolder\">\n<img src=\"https://github.com/qwkdev/x/blob/main/img/logo2.png?raw=true\" width=\"100%\">\n";
