// ==UserScript==
// @name         VENGE.IO HACK MENU
// @description  PRESS ` TO OPEN MENU (ON THE LEFT OF 1)
// @author       XMODS
...
client.MenuElement = class {
  constructor(Hacks, title, left, top){
    ...
    menuElement.style = "left:"+left+"; color: rgba(255, 255, 255, 1) !important; top:"+top+"; margin: 25px; text-align: left; background: rgba(30, 30, 30, 1) !important; font-family: monospace; width:20%; height: auto; position: absolute; border: solid black 4px";
    menuElement.id = title;
    menuElement.innerHTML = "<p style='text-align: center;'>VENGE.IO HACKS <b>V3</b></p><div style='border-bottom: solid black 4px; height: 2.5%; padding: 5%; background-color: rgba(20, 20, 20, 0.7); font-size: 200%; text-align: center' id="+title+"header >"+title+"</div>";
    ...
    for(let i = 0; i < Hacks.length; i++) {
      ...
      document.getElementById(Hacks[i].name).addEventListener("mousedown", function (event){
        ...
        if(!Hacks[i].isEnabled){
          Hacks[i].enable();
          document.getElementById(Hacks[i].name).style.backgroundImage = "linear-gradient(to right, rgba(60, 60, 60, 0.7), rgba(55, 55, 55, 0.7), rgba(30, 30, 30, 0.7))";
        } else {
          Hacks[i].disable();
          document.getElementById(Hacks[i].name).style.backgroundImage = "linear-gradient(to right, rgba(30, 30, 30, 0.7), rgba(30, 30, 30, 0.7), rgba(30, 30, 30, 0.7))";
        };
      });
...
client.menuElement.style.background = "rgba(0, 0, 0, 0.7)";
...
client.keyBindElement.innerHTML = "";
client.menuElement.style.zIndex = 100;
      ...
      for(let i = 0; i < client.Hacks.length; i++){
        if(client.Hacks[i].name == client.keyBinds[event.key]){
          if(client.Hacks[i].isEnabled){
            ...
            document.getElementById(client.Hacks[i].name).style.backgroundImage = "linear-gradient(to right, rgba(30, 30, 30, 0.7), rgba(30, 30, 30, 0.7), rgba(30, 30, 30, 0.7))";
          } else {
            client.Hacks[i].enable();
            document.getElementById(client.Hacks[i].name).style.backgroundImage = "linear-gradient(to right, rgba(60, 60, 60, 0.7), rgba(55, 55, 55, 0.7), rgba(30, 30, 30, 0.7))";
          };
        };
      };
    };
...
client.init = function() {
  ...
  }, "INF JUMP", "Free Jumping", "no keybind");
  ...
  }, "SPEED", "Use Up/Down Arrows", "no keybind");
  ...
  }, "PLAYER TP", "Use Left/Right Arrows To TP", "no keybind");
  ...
  }, "AIMBOT", "All Headshots", "no keybind");
  ...
  }, "INF AMMO", "Inf Ammo/No reload", "no keybind", 1);
  ...
  }, "SPAM CHAT", "Spams the chat", "no keybind", 200);
  ...
  }, "KILL ALL", "Kills Everyone", "no keybind");
  ...
  }, "HELP TP", "TP Away When You Need It", "no keybind");
  ...
  }, "OP GUN", "Makes All Guns OP", "no keybind");
  ...
  }, "NO RECOIL", "No Recoil", "no keybind");
  ...
  }, "INSTA RESPAWN", "Respawn Instantly", "no keybind");
  ...
  }, "CRASH", "Crash The Server", "no keybind");
  ...
  }, "INSTA SWITCH", "No Switch Cool Down", "no keybind");
  ...
  }, "NO DROWN", "Disabled Drowning", "no keybind");
  ...
  }, "NOCLIP", "No Collision", "no keybind");
  ...
  }, "GRENADE SPAM", "No Grenade Cooldown", "no keybind");
  ...
  }, "TURN OFF", "Disable all hacks", "no keybind");
  ...
  }, "INVIS", "Invisible/Invincible", "no keybind");
  //menu elements
  ...
  //win message
  pc.app.on("Game:Finish", function(){client.inGame = false; stophacks.enable();});
